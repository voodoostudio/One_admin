...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->string('procedure_in_progress',100)->nullable();
            ...
            // Surface
            $table->string('surface_cellar',25)->nullable();
            $table->string('ceiling_height',25)->nullable();
            $table->string('roof_cover_area',25)->nullable();
            $table->string('surface_area_terrace_solarium',100)->nullable();
            $table->string('area_veranda',25)->nullable();
            $table->string('attic_space',25)->nullable();
            $table->string('surface_balcony',25)->nullable();
            $table->string('basement_area',25)->nullable();
            $table->string('surface_ground',25)->nullable();
            $table->string('ground',25)->nullable();
            $table->string('serviced',25)->nullable();
            $table->integer('type_land')->nullable();
            $table->string('useful_surface',25)->nullable();
            $table->string('ppe_area',25)->nullable();
            $table->string('volume',25)->nullable();
            $table->string('surface_eng_court',25)->nullable();
            $table->string('lower_ground_floor',25)->nullable();
            $table->string('row_area',25)->nullable();
            $table->string('garage_area',25)->nullable();
            $table->string('weighted_surface',25)->nullable();
            // Stationnement
            $table->string('box_interior_garage',100)->nullable();
            $table->string('box_garage_interior_double',100)->nullable();
            $table->string('outdoor_garage',100)->nullable();
            $table->string('box_garage_outside_double',100)->nullable();
            $table->string('covered_outdoor_parking_space',100)->nullable();
            $table->string('outside_parking_space_uncovered',100)->nullable();
            $table->string('number_parking_spaces',25)->nullable();
            $table->string('boat_shed',100)->nullable();
            $table->string('mooring',100)->nullable();
            // Cuisine
