...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->float('surface_cellar_child')->nullable();
            $table->integer('ceiling_height')->nullable();
            $table->integer('roof_cover_area')->nullable();
            $table->float('roof_cover_area_child')->nullable();
            $table->integer('surf_area_terr_solar')->nullable();
            $table->float('surf_area_terr_solar_child')->nullable();
            $table->integer('area_veranda')->nullable();
            $table->float('area_veranda_child')->nullable();
            $table->integer('attic_space')->nullable();
            $table->float('attic_space_child')->nullable();
            $table->integer('surface_balcony')->nullable();
            $table->float('surface_balcony_child')->nullable();
            $table->integer('basement_area')->nullable();
            $table->float('basement_area_child')->nullable();
            ...
            $table->float('surface_eng_court_child')->nullable();
            $table->integer('lower_ground_floor')->nullable();
            $table->float('lower_ground_floor_child')->nullable();
