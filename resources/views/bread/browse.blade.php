                                ...
                                <div class="form-group m-form__group row align-items-center">
                                    <div class="col-md-4">
                                        <div class="m-input-icon m-input-icon--left">
                                            <input type="text" class="form-control m-input m-input--solid" placeholder="Rechercher..." id="m_form_search">
                                            ...
                                            <div class="modal-content">\
                                                <div class="modal-header">\
                                                    <h5 class="modal-title" id="exampleModalLabel">\
                                                        ' + client_cgu_title_fr + '<br>\
                                                        ' + client_cgu_title_en + '<br>\
                                                        ' + client_cgu_title_es + '<br>\
                                                        </h5>\
                                ...
                                <div class="modal-body">\
                                    ...
                                    <div class="col-lg-12">\
                                        <div class="pure_switch">\
                                            ...
                                            ' + client_cgu_check_text_fr + '<br>\
                                            ' + client_cgu_check_text_en + '<br>\
                                            ' + client_cgu_check_text_es + '<br>\
                                            </label>\
                                </div>\
                            </div>\
                        </div>\
...
//                                console.log(row.id);
                            ...
                            <div class="dropdown ' + dropup + '">\
                                ...
                                <div class="dropdown-menu dropdown-menu-right">\
                                    ...
                                    <button class="dropdown-item" data-toggle="modal" data-target="#remove_confirm_modal_' + row.id + '"><i class="la la-times-circle"></i>Effacer</button>\
                                </div>\
                                <div class="modal fade" id="remove_confirm_modal_' + row.id + '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">\
                                            ...
                                            <form action="{{ URL::to('/admin/add-vip-users') }}" id="vip_users_add_' + row.id + '" method="POST">{{ csrf_field() }}\
                                                <div class="modal-body">\
                                                    <div class="form-group">\
                                                        <select class="form-control m-select2 custom_select2" name="vip_users[]" multiple="multiple">\
