                            ...
                            <div class="m-card-profile">
                                ...
                                <div class="m-card-profile__pic">
                                    <div class="m-card-profile__pic-wrapper">
                                        ...
                                        <img id="child_photo_s" style="display: none;" src="{{ ($dataTypeContent->second_child_photo != null) ? Voyager::image( $dataTypeContent->second_child_photo ) : '/img/admin/default-coup.png' }}" alt="{{ json_decode($dataTypeContent->second_child)->first_name }} avatar"/>
                                        <img id="child_photo_t" style="display: none;" src="{{ ($dataTypeContent->third_child_photo != null) ? Voyager::image( $dataTypeContent->third_child_photo ) : '/img/admin/default-coup.png' }}" alt="{{ json_decode($dataTypeContent->third_child)->first_name }} avatar"/>
                                        <img id="child_photo_f" style="display: none;" src="{{ ($dataTypeContent->fourth_child_photo != null) ? Voyager::image( $dataTypeContent->fourth_child_photo ) : '/img/admin/default-coup.png' }}" alt="{{ json_decode($dataTypeContent->fourth_child)->first_name }} avatar"/>
                                    </div>
                                </div>
