                        ...
                        <div class="m-portlet__body">
                            <div class="m-card-profile">
                                ...
                                <div class="m-card-profile__details">
                                    <span class="m-card-profile__name">{{ ucwords(Auth::user()->name) }}</span>
                                    <a href="" class="m-card-profile__email m-link">{{ ucwords(Auth::user()->email) }}</a>
                                    <p>{{ Auth::user()->bio }}</p>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane active" id="m_user_profile_tab_1">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-7">
                                                <input class="form-control m-input" id="birthplace" type="text" placeholder="Place birth" name="birthplace" value="{{ ($dataTypeContent->birthplace) ? $dataTypeContent->birthplace : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">
