                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                @if(!in_array($row->field, $exclude))
                                    ...
                                    @else
                                        <div class="form-group col-md-4 @if($row->type == 'hidden') hidden @endif @if(isset($display_options->width)){{ 'col-md-' . $display_options->width }}@else{{ '' }}@endif" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                            {{ $row->slugify }}
