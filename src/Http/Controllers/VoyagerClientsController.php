    ...
    public function clientUpdate(Request $request)
    {
        ...
        $clients->where('id', $request->id)
            ->update([
                ...
                'client_emails' => Input::get('client_emails'),
                'coup_emails' => Input::get('coup_emails'),
                'children_emails' => Input::get('children_emails'),
                'client_phones' => Input::get('client_phones'),
                'coup_phones' => Input::get('coup_phones'),
                'children_phones' => Input::get('children_phones'),
                /*-- Coup --*/
                ...
                'preferred_means_contact_coup' => Input::get('preferred_means_contact_coup'),
                /*-- Coup --*/
                ...
                'second_child' => Input::get('second_child'),
                'second_child_photo' => Input::get('second_child_photo'),
                'second_child_emails' => Input::get('second_child_emails'),
                'second_child_phones' => Input::get('second_child_phones'),

                'third_child' => Input::get('third_child'),
                'third_child_photo' => Input::get('third_child_photo'),
                'third_child_emails' => Input::get('third_child_emails'),
                'third_child_phones' => Input::get('third_child_phones'),

                'fourth_child' => Input::get('fourth_child'),
                'fourth_child_photo' => Input::get('fourth_child_photo'),
                'fourth_child_emails' => Input::get('fourth_child_emails'),
                'fourth_child_phones' => Input::get('fourth_child_phones')
            ]);
